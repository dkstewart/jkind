	...
	private void addTypedIntIntCandidates() {
		for (String id1 : this.mapInputOutputLocalTypes.keySet()) {
			for (String id2 : this.mapInputOutputLocalTypes.keySet()) {
				if (	id1 != id2 
						&& this.mapInputOutputLocalTypes.get(id1) != null 
						&& this.mapInputOutputLocalTypes.get(id2) != null
						&& this.mapInputOutputLocalTypes.get(id1).equals(this.mapInputOutputLocalTypes.get(id2))) {
