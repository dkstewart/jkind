...
import jkind.engines.mutation.IfThenElseMutator.IfThenElseMutation;
import jkind.engines.mutation.ReduceBinaryOpMutator.Side;
...
//		mutators.add(new EquationMutator(this, "eq_-2_true", -2, true));
	...
	public MutationEngine(Specification spec, JKindSettings settings, Director director) {
